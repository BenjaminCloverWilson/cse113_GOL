/**
 * @file sdl.h
 * @brief Header file for sdl.o
 * @details Provided for graphics, nothing needed to be changed or added.
 * @author Could be anyone but, Benjamin Wilson
 * @date Fall 2021
 * @todo nothing, already pre-done
 * @bug none
 */
